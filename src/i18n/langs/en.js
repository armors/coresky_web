module.exports = {
	...
	messageTip: {
		...
		ReconfirmPurchase:
			'Invalid orders have been filtered out, please reconfirm the purchase',
		...
		coreCardMintErr: 'This level of CoreCard Mint ends, refresh page',
		refreshDataErr: 'Refresh request submitted, check back in a minute.',
	},
	// 头部导航
	navigation: {
	...
	rewards: {
		title: 'Trade to get Coresky rewards',
		subTitle: 'Trade NFTs on Coresky and get Coresky points',
	...
	form: {
		...
		limitLowestAcceptPrice:
			'*Lowest acceptable price less than start price',
	...
	coreCardMint: {
		title: 'You are claiming "CoreCard V{name}"',
		subTitle: `CoreCard is Coresky's Membership NFT, a decentralized VIP governance system based on the Coresky ecosystem. Become one of the community members and enjoy Coresky exclusive benefits!`,
		connectWallet: 'Connect wallet',
		connect: 'Connect',
		bindtoTwitter: 'Connect Twitter',
		bind: 'Connect',
		retweetTwitter: "Post a tweet about Coresky",
		retweet: 'Post',
		mint: 'Mint',
	},
	userCardList: {
	...
	coreCard: {
		...
		mint: 'Mint Now',
		ticketsWeek: 'Tickets / week',
		connectText: 'Please connect your wallet to access your CoreCard',
		connectWallet: 'Connect Wallet',
		goMintInfo: "Oops! You don't have a CoreCard, please Mint one first.",
		goMint: 'Mint',
