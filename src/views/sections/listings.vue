<template>
	<div class="main-wrapper listings-box">
		<div>
			...
			<div class="flex-com" style="">
				...
				<div class="item display-flex box-center-Y" v-if="isSamePrice">
					<el-input-number v-model="samePrice" @change="samePriceChange" :controls="false" :precision="4" :min="0.0001"
					                 class="input-with-select" :max="100000000000000" size="small"
			...
			<el-button type="primary" class="btn-submit" :loading="sellBtnLoading" @click="getExchangeHashOrder">Confirm the
			                                                                                                     price
			</el-button>
