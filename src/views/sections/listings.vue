    ...
    <div>
      ...
      <div class="flex-com" style="">
        ...
        <div class="item display-flex box-center-Y" v-if="isSamePrice">
          <el-input-number v-model="samePrice" @change="samePriceChange" :controls="false" :precision="4" :min="0.0001"
            class="input-with-select" :max="100000000000000" size="small" style="width:120px;text-align: left" />
        ...
        <div style="margin-left: auto;">
          <div>
            <el-date-picker v-model="form.time" type="datetime" :placeholder="$t('marketListing.PickDate')" style=""
      ...
      <el-table :data="dataList" style="width: 100%" class="mytable" header-row-class-name="head-row">
        ...
        <el-table-column prop="Item" :label="$t('marketListing.ListPrice')" width="200" :show-overflow-tooltip="true">
          <template #default="props">

            <el-input-number v-model="props.row.listPrice" @change="changePrice(props.row.name)" :controls="false"
              :precision="4" :min="0.0001" class="input-with-select" :max="100000000000000" size="small"
              :teleported="false" :disabled="isProceeds ||
        ...
        <el-table-column :label="$t('marketListing.Proceeds')">
          <template #default="props">
            ...
            <el-input-number v-model="props.row.proceeds" @change="changeProceedsPrice(props.row.name)"
              :controls="false" :precision="4" :min="0.0001" :max="100000000000000" class="input-with-select"
              size="small" :teleported="false" :disabled="!isProceeds ||
						(props.row.name === 'Opensea' && !(platformList.find(el => el.name === 'Opensea'))) ||
						(props.row.name === 'Coresky' && !(platformList.find(el => el.name === 'Coresky')))"
              style="width:100px;text-align: left" />
