			...
			<div class="banner-txt-box">
				<div class="banner-txt">
					...
					<div class="txt3">
						<el-button
							class="btn"
							@click="$router.push('/markterplace?rewards=1')"
							type="primary"
							>{{ $t('rewards.goTrade') }}
						</el-button>
					</div>
		...
		<div class="page-center">
			...
			<div class="card-list">
				<div class="card-item">
					<img
						class="image"
						src="@/assets/images/reward02.jpg"
						alt=""
					/>
					<a
						href="https://docs.coresky.com/doc/20/"
						target="_blank"
						class="item-content"
					>
						<span class="ml20">{{
							$t('rewards.RewardsRules')
						}}</span>
						<img
							class="btn-right"
		...
		<div class="page-center" style="margin-bottom:30px">
			<div class="title1">
				...
				<span class="sub-title">
					({{ score }} {{ $t('rewards.CTScore') }})</span
				>
			</div>

			<el-tabs v-model="activeName" class="demo-tabs">
				<el-tab-pane
					:label="$t('rewards.TransactionMining')"
					name="mining"
					:lazy="true"
				>
					<el-table
					...
					>
						...
						>
							<template #default="props">
								...
								<span v-if="props.row.type === 3">{{
									$t('rewards.Rewards')
								}}</span>
								<span v-if="props.row.type === 4">{{
									$t('rewards.ConvertTickets')
								}}</span>
							</template>
						</el-table-column>
						<el-table-column
                ...
                Lazy Cubs Official #1231
					...
					<div
						...
						v-if="listCount > queryParams.limit"
					>
						<div class="content">
							<el-pagination
								background
