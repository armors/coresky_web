...
<!--      </div>-->
      ...
      <div class="sort-box display-flex box-center-Y box-between">
        <div class="display-flex box-center-Y">
          <el-button class="filter display-flex box-center" :class="{active: collectionQuery.order === 1}" @click="changeOrder(1)">
            <div class="icon-img"><img src="../../assets/images/icons/icon_top.svg" alt=""></div>
            <div>{{ $t("home.sortBtnText1") }}</div>
          </el-button>
          <el-button class="filter display-flex box-center" :class="{active: collectionQuery.order === 2}" @click="changeOrder(2)">
            <div class="icon-img"><img src="../../assets/images/icons/icon_trending.svg" alt=""></div>
            <div>{{ $t("home.sortBtnText2") }}</div>
          </el-button>
          <el-button class="filter display-flex box-center" :class="{active: collectionQuery.order === 3}" @click="changeOrder(3)">
            <div class="icon-img"><img src="../../assets/images/icons/icon_mints.svg" alt=""></div>
            <div>{{ $t("home.sortBtnText3") }}</div>
          </el-button>
          <el-button class="filter display-flex box-center" :class="{active: collectionQuery.order === 4}" @click="changeOrder(4)">
        ...
        <div class="display-flex box-center-Y">
          <el-switch
            v-model="collectionQuery.valueRewards"
            :inactive-text="$t('home.reward')"
            class="ml-2"
          />
          <div class="text">{{ $t("home.sortFloor") }}</div>
          <el-input-number class="input-number" @blur="blurPrice" :controls="false" v-model="collectionQuery.minPrice" :placeholder="$t('home.minPlaceholder')"/>
          <div class="line"></div>
          <el-input-number class="input-number" @blur="blurPrice" :controls="false" v-model="collectionQuery.maxPrice" :placeholder="$t('home.maxPlaceholder')"/>
